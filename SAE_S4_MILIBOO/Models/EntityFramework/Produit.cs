...
namespace SAE_S4_MILIBOO.Models.EntityFramework
{
    ...
    public class Produit
    {
        ...
        public virtual ICollection<Variante> VariantesProduitNavigation { get; set; } = null!;
        ...
        public virtual ICollection<ProduitListe> ListeProduitNavigation { get; set; } = null!;
    }
